							...
							<div class="form-items form-body-color">
								...
								<form class="requires-validation" novalidate
									...
									<input class="form-control" type="hidden" name="id"
										value="${producto.getId()}" required>
									<div class="col-md-12 col-sm-12">
										<input class="form-control" type="text" name="nombre"
											placeholder="Nombre completo" value="${producto.getNombre()}"
											required>
									...
									<div class="col-md-12 col-sm-12">
										<input class="form-control" type="text" name="precio"
											placeholder="Precio" value="${producto.getPrecio()}" required>
										...
										<select class="form-select mt-3" name="idCategoria" required>
											<c:forEach items="${categorias}" var="temp">
												...
												<option value="${temp.getId()}"
													${temp.getId() == producto.getIdCategoria() ? 'selected' : ''}><c:out
									...
									<div class="form-button mt-3">
										<button id="submit" type="submit" class="btn btn-success">Modificar
											Producto</button>
									</div>
								</form>
							</div>
